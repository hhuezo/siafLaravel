...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form method="POST" action="{{ route('equipo.store') }}" id="equipoForm">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="step-indicator">
                            ...
                            <div class="step" data-step="3">
                                ...
                                <div class="step-title">Características Físicas</div>
                            </div>
                        </div>

                        <!-- Tabs Navigation (Hidden, used for Bootstrap tab functionality) -->
                        <ul class="nav nav-tabs d-none" id="equipoTabs" role="tablist">
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="codigo_activo" id="codigo_activo"
                                            value="{{ old('codigo_activo') }}" readonly>
                                    </div>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" name="fecha_adquisicion"
                                            id="fecha_adquisicion" value="{{ old('fecha_adquisicion', date('Y-m-d')) }}">
                                    </div>
                                ...
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        <textarea name="otra_caracteristica" id="otra_caracteristica" rows="3"
                                            class="form-control"
                                            placeholder="Ingrese otras características del equipo...">{{ old('otra_caracteristica') }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        <textarea name="detalle" id="detalle" rows="3" class="form-control"
                                            placeholder="Ingrese información adicional sobre el equipo...">{{ old('detalle') }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function loadAmbientes(id, selectedId = null) {
        ...
        function limpiarCamposCalculados() {
            const codigoActivoInput = document.getElementById('codigo_activo');
        ...
        function generarCodigoActivo(subclaseId) {
            ...
            const url = `{{ route('equipo.generarCodigo', ['subclaseId' => 'ID_PLACEHOLDER']) }}`.replace('ID_PLACEHOLDER', subclaseId);
            ...
            fetch(url)
                ...
                .then(data => {
                    if (data.codigo_activo) {
                        codigoActivoInput.value = data.codigo_activo;
