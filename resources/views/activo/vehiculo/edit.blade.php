...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card custom-card">
                ...
                <form method="POST" action="{{ route('vehiculo.update', $vehiculo->id) }}" id="vehiculoForm">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                                ...
                                <div class="row gy-4">
                                        ...
                                        <select name="clase_id" id="clase_id" class="form-select select2"
                                            ...
                                            @foreach ($clases as $clase)
                                                <option value="{{ $clase->id }}"
                                                    @selected(old('clase_id', $vehiculo->clase_id) == $clase->id)>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="codigo_de_activo" id="codigo_de_activo"
                                            value="{{ old('codigo_de_activo', $vehiculo->codigo_de_activo) }}">
                                    </div>
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                                        ...
                                        <input type="number" min="1" class="form-control" name="vida_util" id="vida_util"
                                            value="{{ old('vida_util', $vehiculo->vida_util) }}">
                                    </div>
                                        ...
                                        <select name="fuente_id" id="fuente_id" class="form-select select2">
                                            ...
                                            @foreach ($fuentes as $fuente)
                                                <option value="{{ $fuente->id }}"
                                                    @selected(old('fuente_id', $vehiculo->fuente_id) == $fuente->id)>
                                        ...
                                        <select name="cuenta_contable_id" id="cuenta_contable_id" class="form-select select2">
                                            ...
                                            @foreach ($cuentas as $cuenta)
                                                <option value="{{ $cuenta->id }}"
                                                    @selected(old('cuenta_contable_id', $vehiculo->cuenta_contable_id) == $cuenta->id)>
                                        ...
                                        <select class="form-select select2" name="estado_id" id="estado_id">
                                            ...
                                            @foreach ($estadosActivos as $estadoActivo)
                                                <option value="{{ $estadoActivo->id }}"
                                                    @selected(old('estado_id', $vehiculo->estado_id) == $estadoActivo->id)>
                                        ...
                                        <select class="form-select select2" name="procedencia_id" id="procedencia_id">
                                            ...
                                            @foreach ($procedencias as $procedencia)
                                                <option value="{{ $procedencia->id }}"
                                                    @selected(old('procedencia_id', $vehiculo->procedencia_id) == $procedencia->id)>
                                ...
                                <div class="row gy-4">
                                        ...
                                        <select name="unidad_id" id="unidad_id" class="form-select select2">
                                            ...
                                            @foreach ($unidades as $unidad)
                                                <option value="{{ $unidad->id }}"
                                                    @selected(old('unidad_id', $vehiculo->unidad_id) == $unidad->id)>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="date" class="form-control" name="fecha_de_adquisicion"
                                            id="fecha_de_adquisicion"
                                            value="{{ old('fecha_de_adquisicion', $vehiculo->fecha_de_adquisicion ? \Carbon\Carbon::parse($vehiculo->fecha_de_adquisicion)->format('Y-m-d') : '') }}">
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control" name="valor_inicial"
                                                id="valor_inicial" value="{{ old('valor_inicial', $vehiculo->valor_inicial) }}"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="numero_de_factura"
                                            id="numero_de_factura" value="{{ old('numero_de_factura', $vehiculo->numero_de_factura) }}"
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="depresiable"
                                                ...
                                                {{ old('depresiable', $vehiculo->depresiable) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check form-switch mt-2">
                                            <input class="form-check-input" type="checkbox" name="no_depreciable"
                                                ...
                                                {{ old('no_depreciable', $vehiculo->no_depreciable) ? 'checked' : '' }}>
                                ...
                                <div class="row gy-4">
                                        ...
                                        <select class="form-select select2" name="marca_id" id="marca_id">
                                            ...
                                            @foreach ($marcas as $marca)
                                                <option value="{{ $marca->id }}"
                                                    @selected(old('marca_id', $vehiculo->marca_id) == $marca->id)>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        <input type="number" min="1900" max="{{ date('Y') + 1 }}" class="form-control"
                                            name="anio_fabricacion" id="anio_fabricacion" value="{{ old('anio_fabricacion', $vehiculo->anio_fabricacion) }}"
                                            placeholder="Ej: 2024">
                                    </div>
                                        ...
                                        <select class="form-select select2" name="combustible_id" id="combustible_id">
                                            ...
                                            @foreach ($combustibles as $combustible)
                                                <option value="{{ $combustible->id }}"
                                                    @selected(old('combustible_id', $vehiculo->combustible_id) == $combustible->id)>
                                        ...
                                        <select class="form-select select2" name="traccion_id" id="traccion_id">
                                            ...
                                            @foreach ($tracciones as $traccion)
                                                <option value="{{ $traccion->id }}"
                                                    @selected(old('traccion_id', $vehiculo->traccion_id) == $traccion->id)>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="equipo" id="equipo"
                                            value="{{ old('equipo', $vehiculo->equipo) }}"
                                            oninput="const start = this.selectionStart; const end = this.selectionEnd; this.value = this.value.toUpperCase(); this.setSelectionRange(start, end);">
                                    </div>
                                        ...
                                        <select class="form-select select2" name="estado_fisico_id" id="estado_fisico_id">
                                            ...
                                            @foreach ($estadosFisicos as $estadoFisico)
                                                <option value="{{ $estadoFisico->id }}"
                                                    @selected(old('estado_fisico_id', $vehiculo->estado_fisico_id) == $estadoFisico->id)>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        ...
                                        <textarea name="otra_caracteristica" id="otra_caracteristica" rows="3"
                                            class="form-control"
                                            placeholder="Ingrese otras características del vehículo...">{{ old('otra_caracteristica', $vehiculo->otra_caracteristica) }}</textarea>
                                    </div>

                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        <label for="observacion" class="form-label">Observación</label>
                                        <textarea name="observacion" id="observacion" rows="3" class="form-control"
                                            placeholder="Ingrese observaciones adicionales...">{{ old('observacion', $vehiculo->observacion) }}</textarea>
                                    </div>

                                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                        <label for="detalle" class="form-label">Detalle / descripción</label>
                                        <textarea name="detalle" id="detalle" rows="3" class="form-control"
                                            placeholder="Ingrese información adicional sobre el vehículo...">{{ old('detalle', $vehiculo->detalle) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Cargar datos relacionados del vehículo
            const vehiculoClaseId = {{ $vehiculo->clase_id ?? 'null' }};
            const vehiculoSubclaseId = {{ $vehiculo->subclase_id ?? 'null' }};
            const vehiculoUnidadId = {{ $vehiculo->unidad_id ?? 'null' }};
            const vehiculoAmbienteId = {{ $vehiculo->ambiente_id ?? 'null' }};
            const vehiculoEmpleadoId = {{ $vehiculo->empleado_id ?? 'null' }};
            ...
            if (vehiculoClaseId) {
                loadSubclases(vehiculoClaseId, vehiculoSubclaseId);
            }

            // Cargar ambientes si hay unidad seleccionada
            if (vehiculoUnidadId) {
                loadAmbientes(vehiculoUnidadId, vehiculoAmbienteId, vehiculoEmpleadoId);
            }
