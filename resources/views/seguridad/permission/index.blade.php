                        ...
                        <table id="datatable-basic" class="table table-striped text-nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($permisos as $item)
                                    ...
                                    @include('seguridad.permission.delete')
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Crear permiso</h6>
                ...
                <form method="POST" action="{{ route('permission.store') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                <label for="permission_type_id" class="form-label">Tipo de permiso</label>
                                <select name="permission_type_id" id="permission_type_id" class="form-select">
                                    <option value="">— Sin tipo —</option>
                                    @foreach ($permissionTypes as $type)
                                        <option value="{{ $type->id }}" @selected(old('permission_type_id') == $type->id)>
                                            {{ $type->name }}
                                        </option>
                                    @endforeach
                                </select>
