...
@section('content')
                        ...
                        <table id="datatable-basic" class="table table-striped text-nowrap w-100">
                            ...
                            <tbody>
                                @foreach ($unidades as $item)
                                    ...
                                    @include('catalogo.unidad.edit')
                                    @include('catalogo.unidad.delete')
                                @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title" id="exampleModalLgLabel">Crear Unidad</h6>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            expandMenuAndHighlightOption('catalogoMenu', 'unidadOption');
